...
if ( ! function_exists( 'bf_cpt_portfolio_register_taxonomies' ) ) {
	function bf_cpt_portfolio_register_taxonomies() {
	...
	add_action( 'init', 'bf_cpt_portfolio_register_taxonomies' );
}